...
class TestProductRepository(unittest.TestCase):
    ...
    def test_create_antibiotic_product(self):
        ...
        product.ica = str(self.faker.random_int(1000000000, 9999999999))
        product.price = int(self.faker.random_int(1000000000, 9999999999))
        product.type = PRODUCT_TYPE.Antibiotic
        product.frecuency = int(self.faker.random_int(15, 60))
        product.dose = int(self.faker.random_int(400, 600))
